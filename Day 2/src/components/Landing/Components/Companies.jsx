    ...
    <div className="w-full bg-white py-[50px]">
      <div className="md:max-w-[1480px] m-auto max-w-[600px]  px-4 md:px-0">
        ...
        <p className="text-center  text-[#536E96] text-xl">
          We prioritize the safety and security of our clients, implementing
          rigorous safety protocols and procedures to ensure{" "}
        </p>
        <h3 className="text-center  text-[#536E96] text-xl">
